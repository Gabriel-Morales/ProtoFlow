...
### LAST OPENED & EDITED: Wednesday, January 25, 2022

# Tool: Version B - may be consolidated later when time permits.
...
def parse_packets(capture):
    ...
    for packet in capture:
        ...
        # TCP or UDP indicate LAN data.. NOT 802.11 ethernet traffic.
        if find_in_string(packet.frame_info.protocols, "tcp") or find_in_string(packet.frame_info.protocols, "udp"):
            continue
