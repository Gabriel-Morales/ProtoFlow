...
# Purpose: For all CSV Flowtables in the dir go through and label the appropriate device. Keeps ALL entries
# for semisupervised learning.

abstract_label_devices = {'40:A9:CF:3B:13:DB' : 'audio_video',
...
consolidated_cap = input('Path to consolidated csv file: ')

# df.loc[df['src_mac'] == '0c:dd:24:ff:c8:87', 'label'] = 'test'
